...
<div class="col-lg-9 col-md-9 col-sm-8">
	<?php if((date('n') >= 1 && date('n') <= 4) || (date('n') >= 11)) : ?>
		<p><b>NOTE:</b> The De Pere Sportsmen's Club 3D archery course is closed for the season. It will reopen in spring. We will keep you posted on that date when we get closer to spring. Have a great winter!</p>
	<?php endif; ?>

	<p>The hills behind the Clubhouse are home to one of the finest archery courses found in the state. The 30-station course is open to both members and non-members. Each target is sponsored by an individual or organization, and annually there are opportunities to help keep this course up to date. Check in with one of the league members for more information.</p>

	<p>Open 7 days a week from sunrise to sunset for members and nonmembers starting in early May until late October.  Watch the Facebook page for exact dates. No broadheads allowed on the course.</p>

	<p>Targets and ranges are maintained through the volunteer assistance of Club members, and help is always both welcome and appreciated to keep the course looking its finest. If you take something on the course to eat or drink while you are shooting, please take all garbage out with you to designated disposal sites. Enjoy your outdoor adventure in the natural beauty of the Club woods!</p>
</div>
</div>
<div class="row">
	<div class="col-lg-12"><h2>Sponsors</h2></div>
</div>
<div class="row">
